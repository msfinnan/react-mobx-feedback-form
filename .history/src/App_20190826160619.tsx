    ...
    return (
      <div className="app">
        ...
        <form onSubmit={event => this.handleSubmitEvent(event)}>
          ...
          <input name="bodyTextInput"><BodyText text="(Optional) We would really appreciate if you could take 1 more minute to provide additional details by answering 2 more questions." /></input>
