...
class App extends React.Component<AppProps, {}> {
  @observable private userInputDisplay: string = "no feedback yet";

  private handleSubmit = (event: React.FormEvent<HTMLFormElement>): void => {
    event.preventDefault();
    this.userInputDisplay = this.props.commentBoxStore.commentBoxUserInput;
    console.log(`from app - user feedback is ${this.props.commentBoxStore.commentBoxUserInput}`)
    console.log(`from app - user display is ${this.userInputDisplay}`)
  ...
  public render() {
    return (
      ...
      <div className="app">
        ...
        <ul>
          <li>User Input: {this.userInputDisplay}</li>
        </ul>
      </div>
