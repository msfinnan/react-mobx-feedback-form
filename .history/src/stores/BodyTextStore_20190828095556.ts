...
export class BodyTextStore {
    ...
    @observable public secondText: string ="(Optional) We would really appreciate if you could take 1 more minute to provide additional details by answering 2 more questions."
}